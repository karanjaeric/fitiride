<div class="row" style="min-height:80px;">
	...
	<div id="tab-1" class="tab-content current" data-id="paytm">
      ...
      &nbsp;  &nbsp;
           ...
           TOTAL AMOUNT <span class="rs_left"> Ksh.{{trips.fare}}</span>
                  </div> 
                  </div> 
                     ...
                     <div class="ac-lft-list order">
                        ...
                        <ul>
                           <li>
                              ...
                              <div class="order_contact_inf total last">: Ksh.00</div>
                           </li>
                           <li>
                              <div class="order_cnct_detail total last"> Your Cash </div>
                              <div class="order_contact_inf total last">: Ksh.0    </div>
                           </li>
                           <li>
                              <div class="order_cnct_detail  total last"> Offer Cash </div>
                              <div class="order_contact_inf  total last">  : Ksh.51     </div>
                           </li>
                        </ul>
                     </div>
                     </div>                     
                     ...
                     <div class="ac-lft-list order">  
                        <ul>
                           ...
                           <li>
                              <div class="order_cnct_detail total_lft"> Date of Birth</div>
                               <div class="order_cnct_detail total_dot">: </div>
                              <div class="order_contact_inf total_rht"><input class="pro_num XXinput calendar   date_of_birth dob" type="text" name="dob" required readonly></div>
                           </li>
                           <li>
                              <div class="order_cnct_detail  total_lft"> Gender </div>
                                <div class="order_cnct_detail total_dot">: </div>
