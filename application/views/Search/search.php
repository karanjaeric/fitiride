...
<div class="filter_tb_by"> Filter by</div>
 ...
 <img src="<?php echo base_url();?>assets/images/star.png">&nbsp;Rating
   ...
   <div class="dropdown-menu checklist">
    <ul>
                    <input type="checkbox"  ng-model="value" name="rated"  ng-click="rated('2.7')" /> Higher Rated</li>
                <li>
                <li>
                    <input type="checkbox"  ng-model="value1" name="rated"value="0" /> All Buses</li>
                                       ...
                                       <div id="myCarousel{{$index}}" class="carousel slide" data-ride="carousel">
                                          ...
                                          <div class="carousel-inner" role="listbox">
                                             <div class="item " ng-repeat="busimage in details.gallery" ng-class="{active:$first}">
                                                <img src="<?php echo base_url()?>admin/{{busimage.image}}" alt="Chania" width="460" height="345">
                                             </div>
                                       ...
                                       <table class="cancel_table">
                                          <tbody>
                                             ...
                                             <tr>
                                                ...
                                                <td ng-show="details.type =='percentage'">KES {{details.percentage}}</td>
												<td ng-show="details.type =='flat'" >KES {{details.flat}}</td>
                                             </tr>
                                             <tr>
                                                <td>After {{details.canceltime}}</td>
                                                <td>KES {{details.fare}}</td>
                                             </tr>
 ...
 <div class="modal fade" id="myModalrate{{$index}}" role="dialog">
                                 <div class="modal-dialog" >
									...
									<p ng-show="ratingdetails.length ==0" class="norating"> No Rating</p>
										...
										<div class="bus_dtl" dir-paginate="ratingdetailss in ratingdetails |itemsPerPage:1">
											<div class="bus_dtl1">
					...
					boundary-links="true" >
                     ...
                     <div class="tb_seats_list5">
                        <div class="tb_seats_list1_inner">
                           <p style="font-weight:600;font-size:15px;">KES {{details.fare}}</p>
						   <?php 
         ...
         <div class="seat_arragement seat_view" id="bus{{details.bus_id}}">
            <div class="seat_arragement_outer">
               ...
               <div class="order_contact_inf s">Seat(s):  <span class="tb_fare seat_no"> </span></div><input type="hidden"  class="seat_nos" id="seat_nos{{details.bus_id}}">
               </li>
               <li>
               <div class="order_cnct_detail"><img src="<?php echo base_url();?>assets/images/seat_select.png"> Selected Seat </div>
               <div class="order_contact_inf">Base Fare:  <span class="tb_fare rate_bus">  KES  </span>   </div>
               </li>
               <li>
               <div class="order_cnct_detail"><img src="<?php echo base_url();?>assets/images/booked.png">  Booked  </div>
               <div class="order_contact_inf">  Total Fare   <span class="tb_fare total_rate">  KES {{details.fare}}</span>  </div>
               </li>
               </ul>
               </div>
               </div>
