    ...
    <div style="width:350px; float:left; padding:25px 0 0 0; text-align:center; font-size:18px;font-weight:600; "> BOOKING DETAILS </div>
        ...
        <div style="background:#3a3a3c;     float:left; width:96.3%;  padding:0px 12px 10px 12px;">
            ...
            <div style="width:100%; float:left;">
                ...
                <div style="width:100%; float:left; text-align:center; color:#fff; font-size:15px;"> KES <?php echo $data[0]['amount'];?> </div>
        ...
        * Cancellation charges of KES.100 applicable if cancelled within 30 mins of pickup time. <br />
        * Any Toll, Parking, as applicable. <br />
        * No waiting charges upto 15 mins after scheduled pickup time. KES.50 per 30 mins after that. <br /> 
