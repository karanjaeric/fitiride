<div class="content-wrapper">
   ...
   <section class="content-header">
      <h1>
         Add BoardPoint Details
      </h1>
      <ol class="breadcrumb">
         <li><a href="#"><i class="fa fa-hand-o-up"></i>Home</a></li>
         <li><a href="#">Board point</a></li>
         <li class="active">Add BoardPoint</li>
      </ol>
   </section>
   <!-- Main content -->
         ...
         <div class="col-md-12">
            ...
            <div class="box box-warning">
               <div class="box-header with-border">
                  <h3 class="box-title">Add BoardPoint Details</h3>
               </div>
               <!-- /.box-header -->
               <!-- form start -->
                  ...
                  <div class="box-body">
                     <div class="col-md-6">                      
					    ...
					    <div class="form-group has-feedback">
                           ...
                           <input type="text" class="form-control required" name="pickup_point" data-parsley-trigger="change"	
                   ...
                   <div class="col-md-6">
				       ...
				       <div class="form-group">
                          <label>Route</label>
							<select name="board_point" class="form-control select2 subcat" style="width: 100%;">
							 <?php
