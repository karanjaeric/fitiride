                  ...
                  <div class="box-body">
                     <div class="col-md-6">
					   ...
					   <div class="form-group">
						 ...
						 <div class="bootstrap-timepicker">
							<div class="form-group">
							  ...
							  <div class="input-group">
								<input type="text" name="board_time" class="form-control timepicker">
						...
						<select class="form-control select2 js-example-basic-multiple" style="width: 100%;" name="amenities_id[]" multiple="multiple" id="amenities">
								   <?php
								   //if($amenitiesresult) {
                   ...
                   <div class="col-md-6">
                        ...
                        <div class="form-group has-feedback">
                           ...
                           <input type="text" class="form-control required" name="max_seats" data-parsley-trigger="change" required="" placeholder="Maximum Seats">
                           <span class="glyphicon  form-control-feedback"></span>
                        </div>  
