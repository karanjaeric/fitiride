       ...
       <form role="form" action="" method="post"  class="validate" enctype="multipart/form-data">
                  <div class="box-body">
                     <div class="col-md-6">
                        ...
                        <label>Select Bus</label>
							<select class="form-control select2 required"  style="width: 100%;" name="bus_id">
								   <?php 
								    if($result) {
			...
			<option <?php echo $s; ?> value="<?php echo $busdetails->id; ?>"><?php echo $busdetails->bus_name; ?></option>
						 ...
						 <div class="form-group has-feedback">
                           ...
                           <input type="text" class="form-control required" name="board_point" value="<?php echo $data->board_point; ?>" data-parsley-trigger="change"	
                     ...
                     <button type="submit" class="btn btn-primary">Submit</button>
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group has-feedback">
                           ...
                           <input type="text" class="form-control required" name="fare" value="<?php echo $data->fare; ?>" placeholder="Price" >
                           <span class="glyphicon  form-control-feedback"></span>
                        </div>
						
					    <div class="form-group has-feedback">
                           <label for="exampleInputEmail1">To Place</label>
                           <input type="text" class="form-control required" name="drop_point" value="<?php echo $data->drop_point; ?>" data-parsley-trigger="change"	
