                  ...
                  <div class="box-body">
                   ...
                   <div class="col-md-6">
                        <div class="form-group has-feedback">
                           ...
                           <input type="text" class="form-control required" name="amount" data-parsley-trigger="change"  
				      	...
				      	<div class="form-group has-feedback">
                           ...
                           <input type="text" class="form-control required" id="datepicker" name="expire_date" data-parsley-trigger="change"	
