                     ...
                     <div class="col-md-6">
					      ...
					      <div class="form-group has-feedback">
                           <label for="exampleInputEmail1">Promo Code</label>
                            <input type="text" class="form-control required" value="<?php echo $data->code; ?>" data-parsley-trigger="change"	
                  ...
                  <div class="box-footer">
				   ...
				   <div class="col-md-6">
				        ...
				        <div class="form-group has-feedback">
                           ...
                           <input type="text" class="form-control required" name="amount" value="<?php echo $data->amount; ?>"data-parsley-trigger="change" data-parsley-minlength="2" data-parsley-maxlength="15"  required="" placeholder="Amount">
                           <span class="glyphicon  form-control-feedback"></span>
                        </div>
						
						 <div class="form-group has-feedback">
                           <label for="exampleInputEmail1">Expiry Date</label>
                           <input type="text" class="form-control required" id="datepicker" name="expire_date" value="<?php echo $data->expire_date; ?>"
