                     ...
                     <div class="col-md-6">								
						...
						<div class="form-group has-feedback">
                           <label for="exampleInputEmail1">First Name</label>
                            <input type="text" class="form-control required" value="<?php echo $data->first_name; ?>" data-parsley-trigger="change"	
						...
						<div class="form-group has-feedback">
                           <label for="exampleInputEmail1">Company Name</label>
                            <input type="text" class="form-control required" value="<?php echo $data->company_name; ?>" data-parsley-trigger="change"	
				   ...
				   <div class="col-md-6">
						...
						<div class="form-group has-feedback">
                           <label for="exampleInputEmail1">city</label>
                            <input type="text" class="form-control required" value="<?php echo $data->city; ?>" data-parsley-trigger="change"	
						...
						<div class="form-group has-feedback">
                           <label for="exampleInputEmail1">Last Name</label>
                            <input type="text" class="form-control required" value="<?php echo $data->last_name; ?>" data-parsley-trigger="change"	
                        ...
                        <div class="form-group has-feedback">
                           <label for="exampleInputEmail1">Address</label>
                            <input type="text" class="form-control required" value="<?php echo $data->address; ?>" data-parsley-trigger="change"	
						...
						<div class="form-group has-feedback">
                           <label for="exampleInputEmail1">Phone Number</label>
                            <input type="text" class="form-control required" value="<?php echo $data->phone_number; ?>" data-parsley-trigger="change"	
						...
						<div class="form-group has-feedback">
                           <label for="exampleInputEmail1">Country</label>
                            <input type="text" class="form-control required" value="<?php echo $data->country; ?>" data-parsley-trigger="change"	
