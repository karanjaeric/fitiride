                  ...
                  <div class="box-body">                 
                     <div class="col-md-6">					   
					    ...
					    <div class="form-group has-feedback">
                           ...
                           <input type="text" class="form-control required" name="stoping_point" value="<?php echo $data->stoping_point; ?>" data-parsley-trigger="change"	
                           data-parsley-minlength="2" data-parsley-maxlength="15" data-parsley-pattern="^[a-zA-Z0-9\  \/]+$" required="" placeholder="Stopping Point">
						 ...
						 <div class="bootstrap-timepicker">
							<div class="form-group">
							  ...
							  <div class="input-group">
								<input type="text" value="<?php echo $data->drop_time; ?>" name="drop_time" class="form-control timepicker">
