			    ...
			    <form role="form" action="" method="post" class="validate" enctype="multipart/form-data">
                  <div class="box-body">
                     <div class="col-md-6">                      
					    ...
					    <div class="form-group">
                          <label>Bus Name</label>
							<select class="form-control select2 required"  style="width: 100%;" id="dropbus_details" name="bus_id">
								   <?php
					    ...
					    <div class="form-group has-feedback">
                           ...
                           <input type="text" class="form-control required" name="stoping_point" data-parsley-trigger="change"	
                           data-parsley-minlength="2" data-parsley-maxlength="15" data-parsley-pattern="^[a-zA-Z0-9\  \/]+$" required="" placeholder="Stoping Point">
                           <span class="glyphicon  form-control-feedback"></span>
                        </div>
						
						<div class="form-group has-feedback">
                           <label for="exampleInputEmail1">Landmark</label>
                           <input type="text" class="form-control required" name="landmark" placeholder="Landmark">
                           <span class="glyphicon  form-control-feedback"></span>
                        </div>
                   ...
                   <div class="col-md-6">
				       ...
				       <div class="form-group">
                          <label>Route</label>
							<select name="drop_point" class="form-control select2 subcats" style="width: 100%;">
							 <?php
						  ...
						  <div class="bootstrap-timepicker">
							<div class="form-group">
							  ...
							  <div class="input-group">
								<input type="text" name="drop_time" class="form-control timepicker">
