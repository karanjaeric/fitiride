...
--
-- Host: localhost:3306
-- Generation Time: Jul 28, 2016 at 07:09 AM
...
CREATE TABLE IF NOT EXISTS `book_bus` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `bus_id` int(11) NOT NULL,
